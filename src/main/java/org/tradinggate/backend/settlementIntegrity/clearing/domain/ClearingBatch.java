...
public class ClearingBatch {
    ...
    public static ClearingBatch retryPendingOf(ClearingBatch failedBatch, int nextAttempt) {
        return ClearingBatch.builder()
                .businessDate(failedBatch.getBusinessDate())
                .batchType(failedBatch.getBatchType())
                .runKey(failedBatch.getRunKey())
                .attempt(nextAttempt)
                .retryOfBatchId(failedBatch.getId())
                .scope(failedBatch.getScope())
                .status(ClearingBatchStatus.PENDING)
                .cutoffOffsets(Map.of())
                .build();
    }
