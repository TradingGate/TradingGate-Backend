...
public class Order {
    ...
    public static Order restore(OrderSnapshot os) {
        return Order.builder()
                .orderId(os.getOrderId())
                .accountId(os.getAccountId())
                .clientOrderId(os.getClientOrderId())
                .symbol(os.getSymbol())
                .side(os.getSide())
                .orderType(os.getOrderType())
                .timeInForce(os.getTimeInForce())
                .price(os.getPrice())
                .quantity(os.getQuantity())
                .remainingQuantity(os.getRemainingQuantity())
                .filledQuantity(os.getFilledQuantity())
                .avgFilledPrice(os.getAvgFilledPrice())
                .status(os.getStatus())
                .rejectReason(os.getRejectReason())
                .receivedAtMillis(os.getReceivedAtMillis())
                .createdAtMillis(os.getCreatedAtMillis())
                .updatedAtMillis(os.getUpdatedAtMillis())
                .lastEventSeq(os.getLastEventSeq())
                .build();
    }
