...
import org.tradinggate.backend.matching.domain.e.PreCheckRejectReason;
...
public class MatchingEngineImpl implements MatchingEngine {
    ...
    /**
     * 심볼별 오더북 관리
     * - 단일 워커 인스턴스가 여러 심볼을 담당
     * - 같은 심볼은 항상 같은 워커(파티션)에서만 처리된다는 전제
     */
    ...
    public MatchResult handle(OrderCommand command, long currentTimeMillis) {
        ...
        OrderBook orderBook = orderBooks.computeIfAbsent(symbol, OrderBook::create);
